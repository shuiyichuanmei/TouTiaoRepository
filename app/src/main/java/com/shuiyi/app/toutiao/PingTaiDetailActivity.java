...
/**
 * Created by Hey on 2016/6/23.
 */
@SuppressLint("JavascriptInterface")
public class PingTaiDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pingtaidetail);
