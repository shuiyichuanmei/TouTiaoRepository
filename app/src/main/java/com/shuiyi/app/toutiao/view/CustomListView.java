...
public class CustomListView extends ListView implements OnScrollListener {
	...
	public void onScroll(AbsListView pView, int pFirstVisibleItem,
		...
		if (onMyScroll!=null) {
			onMyScroll.onMyScroll(pView,pFirstVisibleItem,pVisibleItemCount,pTotalItemCount);
		}
	}
	
	private onMyScrollListener onMyScroll;
	public void setOnMyScroll(onMyScrollListener onMyScroll){
		this.onMyScroll=onMyScroll;
	}
	public interface onMyScrollListener {
		public void onMyScroll(AbsListView pView, int pFirstVisibleItem,
							   int pVisibleItemCount, int pTotalItemCount);
	}
