...
public class ImageCycleView extends LinearLayout {
     ...
     */
    public void setImageResources(ArrayList<ImageBean> imageUrlList,
        ...
        if (imageUrlList.size() > 0) {
            imageName.setText(imageUrlList.get(0).getImginfo());
        }
        ...
        mAdvPager.setCurrentItem(imageUrlList.size() * 4);
        startImageTimerTask();
    }
    ...
    private final class GuidePageChangeListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int index) {
            ...
            // 设置图片滚动指示器背
            mImageViews[index]
                    .setBackgroundResource(R.drawable.guide_check);
            imageName.setText(imageUrlList.get(index).getImginfo());
            for (int i = 0; i < mImageViews.length; i++) {
                if (index != i) {
                    mImageViews[i]
                            .setBackgroundResource(R.drawable.guide_uncheck);
                }
            }
        }
    }
    ...
    private class ImageCycleAdapter extends PagerAdapter {
        ...
        public ImageCycleAdapter(Context context, ArrayList<ImageBean> adList,
                                 ImageCycleViewListener imageCycleViewListener) {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            // } else {
            // imageView = mImageViewCacheList.get(position);
            // }
        ...
        public void destroyItem(ViewGroup container, int position, Object object) {
            ...
            // mImageViewCacheList.remove(view);
